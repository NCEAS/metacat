...
- Download Metacat
    ...
    - Binary Distribution (A war file installation)
        - GZIP File: metacat-bin-2.7.1.tar.gz_
        - ZIP File: metacat-bin-2.7.1.zip_
    - Source Distribution (Full source, requiring build)
        - GZIP File: metacat-src-2.7.1.tar.gz_
        - ZIP File: metacat-src-2.7.1.zip_
    - `Older versions`_
...
.. _metacat-bin-2.7.1.tar.gz: http://knb.ecoinformatics.org/software/dist/metacat-bin-2.7.1.tar.gz

.. _metacat-bin-2.7.1.zip: http://knb.ecoinformatics.org/software/dist/metacat-bin-2.7.1.zip

.. _metacat-src-2.7.1.tar.gz: http://knb.ecoinformatics.org/software/dist/metacat-src-2.7.1.tar.gz

.. _metacat-src-2.7.1.zip: http://knb.ecoinformatics.org/software/dist/metacat-src-2.7.1.zip
