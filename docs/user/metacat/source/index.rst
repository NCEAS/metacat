...
- Download Metacat
    ...
    - Binary Distribution (A war file installation)
        - GZIP File: metacat-bin-2.4.2.tar.gz_
        - ZIP File: metacat-bin-2.4.2.zip_
    - Source Distribution (Full source, requiring build)
        - GZIP File: metacat-src-2.4.2.tar.gz_
        - ZIP File: metacat-src-2.4.2.zip_
    - `Older versions`_
...
.. _metacat-bin-2.4.2.tar.gz: http://knb.ecoinformatics.org/software/dist/metacat-bin-2.4.2.tar.gz

.. _metacat-bin-2.4.2.zip: http://knb.ecoinformatics.org/software/dist/metacat-bin-2.4.2.zip

.. _metacat-src-2.4.2.tar.gz: http://knb.ecoinformatics.org/software/dist/metacat-src-2.4.2.tar.gz

.. _metacat-src-2.4.2.zip: http://knb.ecoinformatics.org/software/dist/metacat-src-2.4.2.zip
