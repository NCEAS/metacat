...
> [!IMPORTANT]
> ### Before You Start:
> 1. After you have read the details below, [this checklist](docs/MetacatQuickRef.md)) may be helpful in guiding you through the necessary installation steps.
>
>
> 2. If you are considering **migrating an existing Metacat installation to Kubernetes**, note that ***before starting a migration, you must have a fully-functioning installation of Metacat version 2.19 or greater, running with PostgreSQL version 14 or greater. Migrating from other versions of Metacat and/or PostgreSQL is not supported.*** See [this checklist](docs/MetacatQuickRef.md)) for the necessary migration steps.
>
>
