...
#run the class
java -cp $METACAT:$XALAN:$COMMONS_CONFIG:$COMMONS_LOG:$COMMONS_LANG:$COMMONS_COLLECTION:$COMMONS_JXPATH:$LOG4J:$UTILITIES:$D1_COMMON:$JBCRYPT edu.ucsb.nceas.metacat.authentication.AuthFile $BASE_WEB_INF $1
