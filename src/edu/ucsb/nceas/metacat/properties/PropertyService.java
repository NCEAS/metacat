...
public class PropertyService extends BaseService {
   ...
   * dev.runConfiguration=false and -- backup properties file exists Note that dev.runConfiguration
   * should only be set to false when reinstalling the same version of the application in
   * developement.
   *
   * @return a boolean that is false if dev.runConfiguration is false and the backup properties file
   * exists.
   */
