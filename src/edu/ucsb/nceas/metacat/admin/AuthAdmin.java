...
public class AuthAdmin extends MetacatAdmin {
    ...
    public void configureAuth(HttpServletRequest request, HttpServletResponse response)
        ...
        if (processForm == null || !processForm.equals("true") || formErrors != null) {
            ...
            try {
                ...
                Vector<String> orgPropertyNames =
                ...
                throw new AdminException("AuthAdmin.configureAuth - Problem getting property "
                                             + "while initializing LDAP properties page: "
                                             + gpe.getMessage());
            ...
            try {
                ...
                SortedMap<Integer, MetaDataProperty> globalPropertyMap =
                    authMetaData.getPropertiesInGroup(1);
     ...
     *
     * AuthSessions were previously created based on a selected authentication class. As LDAP and
     * Password based authentication is being deprecated, we no longer have to check for a valid
     * authentication class. The user is now (2024) expected to provide an ORCID ID of the form
     * http://orcid.org/0000-0003-0958-4367 (http, NOT https)
     *
