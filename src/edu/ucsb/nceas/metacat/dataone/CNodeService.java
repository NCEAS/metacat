...
public class CNodeService extends D1NodeService
    ...
    /* the logger instance */
    private final Log logMetacat = LogFactory.getLog(CNodeService.class);
            ...
            if (replicaEntryIndex != -1) {
                ...
                if (targetReplica.getReplicationStatus().equals(ReplicationStatus.COMPLETED)
                    ...
                    throw new InvalidRequest(
                        ...
                        + " to " + status + "is prohibited for identifier "
        ...
        try {
            ...
            try {
                ...
                boolean changeModificationDate =
                    version != null && version.equalsIgnoreCase(D1NodeVersionChecker.V1);
                ...
                if (replicaNode.getValue()
                    ...
                    if (!listedReplica.getReplicationStatus().equals(replicaStatus) && listedReplica
                        ...
                        throw new InvalidRequest(
                            ...
                            + replicaStatus + "is prohibited for identifier "
