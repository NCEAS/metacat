...
<div class="document">
	...
	%> 	
				<div class="alert alert-success"><i class="icon-thumbs-up"></i>Configuration of Metacat is complete,
				now restart Tomcat so that both webapps are initialized with these settings.  
