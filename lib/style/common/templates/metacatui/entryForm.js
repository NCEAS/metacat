    ...
    if (evt) {
        ...
        if (elem) {
            try {
							...
							var tableBody = elem.parentNode.parentNode.parentNode.parentNode;
...
function createPartyRow(partyCount, partyLastName, partyFirstName, partyRole, 
	  partyOrgName, partyEmail, partyPhone, partyFAX, partyDelivery, partyCity, 
	  partyState, partyStateOther, partyZip, partyCountry) {    
...
function editParty(evt) {
  ...
  var pEmail = pOrgName.nextElementSibling;    
	document.getElementById("assocPartyEmail").value = pEmail.value;
	
  var pPhone = pEmail.nextElementSibling;      
...
function updateAssociatedParty() {
  ...
  var pFirstNameColumn = pCountry.nextElementSibling;
	pFirstNameColumn.textContent = pFirstName.value;
	
  var pLastNameColumn = pFirstNameColumn.nextElementSibling;
	pLastNameColumn.textContent = pLastName.value;
	
	var partyRole = document.getElementById("assocPartyRole");   
  var pRoleColumn = pLastNameColumn.nextElementSibling;
