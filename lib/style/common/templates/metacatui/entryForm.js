	    ...
	    var partyCount = incrementCount("partyCount");
			...
			try {
				var partyRow = createPartyRow(
					...
					partyRole.options[partyRole.selectedIndex].text,
					partyOrgName.value,   
					partyEmail.value,     
					partyPhone.value,     
					partyFAX.value,       
					partyDelivery.value,  
					partyCity.value,      
					partyState.options[partyState.selectedIndex].text,     
...
function createPartyRow(partyCount, partyLastName, partyFirstName, partyRole, partyOrgName, partyEmail, partyPhone, partyFAX, partyDelivery, partyCity, partyState, partyStateOther, partyZip, partyCountry) {    
    ...
    delCol.appendChild(createIconLink("icon-remove-sign", "Delete", "delRow(event)", "pointer"));
		...
		var partyRoleText = document.createTextNode(partyRole);
    ...
    partyRow.appendChild(createHiddenInput("partyRole", partyRole));
    ...
    partyRow.appendChild(createHiddenInput("partyState", partyState));
...
function editParty(evt) {
  ...
  var pRole = pLastName.nextSibling;  // need to set the selected option
	//document.getElementById("partyRole").value = pRole.value;
  ...
  var pState = pCity.nextSibling; // need to set the selected option       
	//document.getElementById("partyState").value = pState.value;
...
function updateAssociatedParty() {
  ...
  var pRole = pLastName.nextSibling;   
	//pRole.options[partyRole.selectedIndex].text = document.getElementById("partyRole").value;
  ...
  var pState = pCity.nextSibling;       
	//pState.options[partyState.selectedIndex].text = document.getElementById("partyState").value;
