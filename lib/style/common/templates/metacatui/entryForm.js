...
function sortInputTags() {
    sortTagWithAttributeName("partyFirstName", "addAssociatedParty");
    sortTagWithAttributeName("partyLastName", "addAssociatedParty");
    sortTagWithAttributeName("partyRole", "addAssociatedParty", "select");
...
function addAssociatedParty() {
	var partyFirstName  = document.getElementById("partyFirstName");
	var partyLastName   = document.getElementById("partyLastName");
	var partyRole       = document.getElementById("partyRole");
	var partyOrgName    = document.getElementById("partyOrgName");
	var partyEmail      = document.getElementById("partyEmail");
	var partyPhone      = document.getElementById("partyPhone");
	var partyFAX        = document.getElementById("partyFAX");
	var partyDelivery   = document.getElementById("partyDelivery");
	var partyCity       = document.getElementById("partyCity");
	var partyState      = document.getElementById("partyState");
	var partyStateOther = document.getElementById("partyStateOther");
	var partyZip        = document.getElementById("partyZip");
	var partyCountry    = document.getElementById("partyCountry");

	if (partyLastName.value != "" || partyOrgName.value != "") {
...
function createPartyRow(partyCount, partyLastName, partyFirstName, partyRole, partyOrgName, partyEmail, partyPhone, partyFAX, partyDelivery, partyCity, partyState, partyStateOther, partyZip, partyCountry) {    
    ...
    /*
    if (navigator.userAgent.toLowerCase().indexOf('msie')!= -1 && document.all) {
        editCol.attachEvent("onclick", new Function("partyEditRow(event, 0, \"" + partyFirstName  + "\",\""
                         + partyLastName  + "\",\"" + partyRole + "\")"));
    } else {
        editCol.setAttribute("onClick","partyEditRow(event, 0, \"" + partyFirstName  + "\",\""
                         + partyLastName  + "\",\"" + partyRole + "\")");
    }
		*/
		
    partyRow.appendChild(createHiddenInput("storedPartyFirstName", partyFirstName));
    partyRow.appendChild(createHiddenInput("storedPartyLastName", partyLastName));
    partyRow.appendChild(createHiddenInput("storedPartyRole", partyRole.value));
    partyRow.appendChild(createHiddenInput("storedPartyOrgName", partyOrgName));
    partyRow.appendChild(createHiddenInput("storedPartyEmail", partyEmail));
    partyRow.appendChild(createHiddenInput("storedPartyPhone", partyPhone));
    partyRow.appendChild(createHiddenInput("storedPartyFAX", partyFAX));
    partyRow.appendChild(createHiddenInput("storedPartyDelivery", partyDelivery));
    partyRow.appendChild(createHiddenInput("storedPartyCity", partyCity));
    partyRow.appendChild(createHiddenInput("storedPartyState", partyState.value));
    partyRow.appendChild(createHiddenInput("storedPartyStateOther", partyStateOther));
    partyRow.appendChild(createHiddenInput("storedPartyZip", partyZip));
    partyRow.appendChild(createHiddenInput("storedPartyCountry", partyCountry));
...
function editParty(evt) {
  ...
  var pFirstName = targetRow.firstChild;    
	document.getElementById("partyFirstName").value = pFirstName.value;
	
  var pLastName = pFirstName.nextSibling;  
	document.getElementById("partyLastName").value = pLastName.value;
	
  var pRole = pLastName.nextSibling;
	var partyRole = document.getElementById("partyRole");
	partyRole.options.value = pRole.value;
	partyRole.value = pRole.value;
	partyRole.options[partyRole.options.selectedIndex].selected = true;
  
	var pOrgName = pRole.nextSibling;       
	document.getElementById("partyOrgName").value = pOrgName.value;
	
  var pEmail = pOrgName.nextSibling;    
	document.getElementById("partyEmail").value = pEmail.value;
	
  var pPhone = pEmail.nextSibling;      
	document.getElementById("partyPhone").value = pPhone.value;
	
  var pFAX = pPhone.nextSibling;      
	document.getElementById("partyFAX").value = pFAX.value;
	
  var pDelivery = pFAX.nextSibling;        
	document.getElementById("partyDelivery").value = pDelivery.value;
	
  var pCity = pDelivery.nextSibling;   
	document.getElementById("partyCity").value = pCity.value;
	
  var pState = pCity.nextSibling;       
	var partyState = document.getElementById("partyState");
	partyState.value = pState.value;
	partyState.options.value = pState.value;
	partyState.options[partyState.options.selectedIndex].selected = true;
	
  var pStateOther = pState.nextSibling;      
	document.getElementById("partyStateOther").value = pStateOther.value;
	
  var pZip = pStateOther.nextSibling; 
	document.getElementById("partyZip").value = pZip.value;
	
  var pCountry = pZip.nextSibling;        
	document.getElementById("partyCountry").value = pCountry.value;
...
function updateAssociatedParty() {
  ...
  var pFirstName = selectedRow.firstChild;    
	pFirstName.value = document.getElementById("partyFirstName").value;
	
  var pLastName = pFirstName.nextSibling;  
	pLastName.value = document.getElementById("partyLastName").value;
	
  var pRole = pLastName.nextSibling;   
	pRole.value = document.getElementById("partyRole").value;
	
  var pOrgName = pRole.nextSibling;       
	pOrgName.value = document.getElementById("partyOrgName").value;
	
  var pEmail = pOrgName.nextSibling;    
	pEmail.value = document.getElementById("partyEmail").value;
	
  var pPhone = pEmail.nextSibling;      
	pPhone.value = document.getElementById("partyPhone").value;
	
  var pFAX = pPhone.nextSibling;      
	pFAX.value = document.getElementById("partyFAX").value;
	
  var pDelivery = pFAX.nextSibling;        
	pDelivery.value = document.getElementById("partyDelivery").value;
	
  var pCity = pDelivery.nextSibling;   
	pCity.value = document.getElementById("partyCity").value;
	
  var pState = pCity.nextSibling;       
	pState.value = document.getElementById("partyState").value;
	
  var pStateOther = pState.nextSibling;      
	pStateOther.value = document.getElementById("partyStateOther").value;
	
  var pZip = pStateOther.nextSibling; 
	pZip.value = document.getElementById("partyZip").value;
	
  var pCountry = pZip.nextSibling;        
	pCountry.value = document.getElementById("partyCountry").value;
  ...
  var updateButton = document.getElementById("updatePartyButton");
	...
	/* Clear the form */
	document.getElementById("partyFirstName").value = "";
	document.getElementById("partyLastName").value = "";
	document.getElementById("partyRole").selectedIndex = 0;
	document.getElementById("partyOrgName").value = "";
	document.getElementById("partyEmail").value = "";     
	document.getElementById("partyPhone").value = "";     
	document.getElementById("partyFAX").value = "";       
	document.getElementById("partyDelivery").value = "";  
	document.getElementById("partyCity").value = "";      
	document.getElementById("partyState").selectedIndex = 0;  
	document.getElementById("partyStateOther").value = "";
	document.getElementById("partyZip").value = "";       
	document.getElementById("partyCountry").value = "";
...
function copyContact() {
    ...
    if (checkBox.checked == true)
    {
        ...
        var ono = document.getElementById("partyOrgName");
        cno.value = ono.value;
        cno.disabled = "true";
