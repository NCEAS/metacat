...
public class GetResults  implements java.io.Serializable {
    ...
    /**
     * Gets the wfID value for this GetResults.
     * 
     * @return wfID
     */
    ...
    /**
     * Sets the wfID value for this GetResults.
     * 
     * @param wfID
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://executionWS.kepler.org/xsd", ">getResults"));
