...
public class DefaultDataCiteFactoryTest extends MCTestCase {
    private static final String RESULT= "<?xml version=\"1.0\"?> <resource xmlns=\"http://datacite.org/schema/kernel-3\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://datacite.org/schema/kernel-3 https://schema.datacite.org/meta/kernel-3.1/metadata.xsd\"><identifier identifierType=\"DOI\">doi:10.5063/F1X34VQ5</identifier><creators><creator>CN=Monica Ihli A139616,O=Google,C=US,DC=cilogon,DC=org</creator></creators><title xml:lang=\"en\">(:unkn)</title><publisher>My Metacat Node</publisher><publicationYear>2017</publicationYear><resourceType resourceTypeGeneral=\"Dataset\">Dataset/metadata</resourceType><formats><format>text/xml</format></formats></resource>";
